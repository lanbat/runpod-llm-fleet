...
| Purpose | Directory | Current model | Consumer |
|---|---|---|---|
| Coding assistant backend | [`models/coding-agent`](models/coding-agent) | Qwen3-Coder-30B-A3B-Instruct (AWQ) | [opencode](https://opencode.ai) |
